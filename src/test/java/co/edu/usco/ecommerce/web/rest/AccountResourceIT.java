...
import co.edu.usco.ecommerce.EcommerceEp4App;
import co.edu.usco.ecommerce.config.Constants;
import co.edu.usco.ecommerce.domain.User;
import co.edu.usco.ecommerce.repository.AuthorityRepository;
import co.edu.usco.ecommerce.repository.UserRepository;
import co.edu.usco.ecommerce.security.AuthoritiesConstants;
import co.edu.usco.ecommerce.service.UserService;
import co.edu.usco.ecommerce.service.dto.PasswordChangeDTO;
import co.edu.usco.ecommerce.service.dto.UserDTO;
import co.edu.usco.ecommerce.web.rest.vm.KeyAndPasswordVM;
import co.edu.usco.ecommerce.web.rest.vm.ManagedUserVM;
...
import static co.edu.usco.ecommerce.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = EcommerceEp4App.class)
